...
public class SeatPassFileReader implements SeatPassProvider {
	...
	private static final String PASS_LIST_CSV_LIST = "src/main/resources/cleancode/studycafe/pass-list.csv";

	@Override
	public StudyCafeSeatPasses getSeatPasses() {
		try {
			List<String> lines = Files.readAllLines(Paths.get(PASS_LIST_CSV_LIST));
