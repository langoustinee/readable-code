...
public class LockerPassFileReader implements LockerPassProvider {
	...
	private static final String LOCKER_LIST_CSV_LIST = "src/main/resources/cleancode/studycafe/locker.csv";

	@Override
	public StudyCafeLockerPasses getLockerPasses() {
		try {
			List<String> lines = Files.readAllLines(Paths.get(LOCKER_LIST_CSV_LIST));
